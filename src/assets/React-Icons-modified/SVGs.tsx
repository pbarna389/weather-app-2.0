...
export const SearchIcon:React.FC<ISVG> = ({ width = 80}) => {
    return (
        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height={width} width={width} xmlns="http://www.w3.org/2000/svg" data-svg="search">
            <linearGradient id="searchbar" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="#ffffff"/>
                <stop offset="100%" stopColor="rgb(110, 110, 110)"/>
            </linearGradient>
            <path fill="url(#searchbar)" d="M10 18a7.952 7.952 0 0 0 4.897-1.688l4.396 4.396 1.414-1.414-4.396-4.396A7.952 7.952 0 0 0 18 10c0-4.411-3.589-8-8-8s-8 3.589-8 8 3.589 8 8 8zm0-14c3.309 0 6 2.691 6 6s-2.691 6-6 6-6-2.691-6-6 2.691-6 6-6z" data-svg="search"></path>
            <path fill="url(#searchbar)" d="M11.412 8.586c.379.38.588.882.588 1.414h2a3.977 3.977 0 0 0-1.174-2.828c-1.514-1.512-4.139-1.512-5.652 0l1.412 1.416c.76-.758 2.07-.756 2.826-.002z" data-svg="search"></path>
        </svg>
